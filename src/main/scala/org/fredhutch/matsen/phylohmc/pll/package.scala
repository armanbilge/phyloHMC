...
package object pll {
  ...
  private[pll] class Operation(parent_clv_index: Int, parent_scaler_index: Int, child1_clv_index: Int, child1_matrix_index: Int, child1_scaler_index: Int, child2_clv_index: Int, child2_matrix_index: Int, child2_scaler_index: Int) extends Structure with Structure.ByValue {
  ...
  @native private[pll] def pll_update_partials(partition: PartitionPointer, operations: Array[Operation], count: Int): Double
